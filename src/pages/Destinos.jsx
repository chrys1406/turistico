...
const DESTINOS = [
  {
    ...
    categoria: "Mirador",
    descripcion:
      "El mirador más famoso de La Paz con vista panorámica de la ciudad y el nevado Illimani.",
    distancia: "2 km",
    rating: 4.8,
    tiempo: "1-2 horas",
    img: mirador,
  ...
  },
  {
    ...
    descripcion:
      "La red de teleféricos más alta del mundo conectando La Paz y El Alto.",
    distancia: "Centro",
    rating: 4.9,
    tiempo: "1-2 horas",
    img: teleferico,
  ...
  },
  {
    ...
    categoria: "Cultura",
    descripcion:
      "Una de las ferias más grandes de Sudamérica, con artesanías, comida y tradición.",
    distancia: "12 km",
    rating: 4.7,
    tiempo: "2-3 horas",
    img: feria,
    coords: [-16.5036, -68.15],
    tag: "Cultural",
  },
  {
    id: 4,
    ...
    descripcion:
      "Formaciones rocosas únicas que simulan un paisaje lunar a solo 10 km del centro.",
    distancia: "10 km",
    rating: 4.8,
    tiempo: "2-3 horas",
    img: valle,
    coords: [-16.55, -68.0833],
    tag: "Naturaleza",
  },
  {
    id: 5,
    ...
    categoria: "Naturaleza",
    descripcion:
      "El lago navegable más alto del mundo, a 3.800 metros sobre el nivel del mar.",
    distancia: "70 km",
    rating: 4.9,
    tiempo: "Día completo",
    img: titicaca,
  ...
  },
  {
    ...
    categoria: "Aventura",
    descripcion:
      "Pueblo yungas con paisajes tropicales, cascadas y la famosa Ruta de la Muerte.",
    distancia: "90 km",
    rating: 4.8,
    tiempo: "Día completo",
    img: coroico,
...
function Img({ src, alt, className }) {
  ...
  return err ? (
    <div
      className={`${className} flex flex-col items-center justify-center bg-slate-100 border-2 border-dashed border-slate-200 text-slate-400`}
    >
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="pt-32 pb-16 px-6 md:px-12"
      >
        <div className="max-w-[1440px] mx-auto">
          ...
          <p className="text-slate-400 text-base max-w-xl">
            Descubre los lugares más increíbles de La Paz y El Alto, desde
            miradores hasta aventuras en los Yungas.
          </p>
