      ...
      <section className="max-w-[1440px] mx-auto bg-white min-h-screen">
        ...
        <div className="lg:hidden pt-20 px-4 pb-6">
          ...
          <p className="text-slate-500 mt-3 text-sm leading-relaxed">
            Historia, cultura y naturaleza en la capital más alta del mundo, a
            3.640 metros sobre el nivel del mar.
          </p>
          ...
          <div className="grid grid-cols-2 gap-3 mt-3">
            ...
            >
              ...
              <div className="absolute bottom-3 left-3">
                <span className="inline-block bg-amber-500 text-white text-[9px] font-bold px-1.5 py-0.5 rounded uppercase mb-1">
                  Icónico
                </span>
            ...
            {rutas.map((r, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3
                    className="font-bold text-sm md:text-base mb-3 md:mb-4"
                    style={{ fontFamily: "'Playfair Display', serif" }}
                  >
                    {r.nombre}
                  </h3>
        ...
        {/* ── CTA FINAL ── */}
        <div
          className="mx-4 md:mx-12 mb-8 md:mb-12 rounded-2xl md:rounded-3xl overflow-hidden relative"
        ...
        >
          ...
          <div
            className="relative z-10 px-6 py-12 md:p-12 text-center flex flex-col items-center justify-center"
            style={{ minHeight: "250px" }}
          >
            ...
            <h2
              className="text-2xl md:text-4xl lg:text-5xl font-black text-white mb-5 md:mb-6"
              style={{ fontFamily: "'Playfair Display', serif" }}
            >
              ¿Listo para explorar
              <br />
            ...
            >
              <Mountain size={16} /> Abrir Mapa Interactivo{" "}
              <ArrowRight size={14} />
            </a>
          </div>
        </div>
