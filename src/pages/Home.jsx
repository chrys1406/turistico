...
import calle    from '../assets/fondo/calle.jpg'
...
const rutas = [
  { nombre: 'Ruta Colonial',   paradas: 5, duracion: '4h', dificultad: 'Fácil',    emoji: '🏛️' },
  { nombre: 'Ruta Naturaleza', paradas: 4, duracion: '6h', dificultad: 'Moderada', emoji: '🌿' },
  { nombre: 'Ruta El Alto',    paradas: 6, duracion: '5h', dificultad: 'Fácil',    emoji: '🏔️' },
]

const stats = [
  { valor: '50+',    label: 'Destinos' },
  ...
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: '#f8f9fa', color: '#1a1a2e' }}>
      ...
      <section className="max-w-[1440px] mx-auto bg-white min-h-screen">
        ...
        <div className="px-4 md:px-12 pt-28 pb-10 grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
              ...
              <div className="md:col-span-8 relative rounded-2xl overflow-hidden" style={{ minHeight: '340px' }}>
                <Img
                  src={IMGS.teleferico}
              ...
              {[
                ...
                >
                  ...
                  <div className="p-4 flex-1">
                    <h3 className="font-bold text-sm text-slate-900" style={{ fontFamily: "'Playfair Display', serif" }}>
                      {d.nombre}
                    </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
            {rutas.map((r, i) => (
              ...
              >
                ...
                <h3 className="font-bold text-base mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
                  {r.nombre}
                </h3>
                <div className="space-y-2 text-sm" style={{ color: activeRuta === i ? 'rgba(255,255,255,0.6)' : '#64748b' }}>
                  <div className="flex justify-between">
                    <span>Paradas</span>
                    <span style={{ color: activeRuta === i ? '#fff' : '#1a1a2e', fontWeight: 700 }}>{r.paradas}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Duración</span>
                    <span style={{ color: activeRuta === i ? '#fff' : '#1a1a2e', fontWeight: 700 }}>{r.duracion}</span>
                  </div>
                  <div className="flex justify-between">
        ...
        {/* ── CTA FINAL ── */}
        <div className="mx-4 md:mx-12 mb-12 rounded-3xl overflow-hidden relative" style={{ minHeight: '300px' }}>
          <Img
            src={IMGS.calle}
            alt="La Paz"
            className="w-full h-full object-cover absolute inset-0"
          ...
          <div className="relative z-10 p-12 text-center flex flex-col items-center justify-center" style={{ minHeight: '300px' }}>
            <p className="text-xs font-bold tracking-[0.3em] text-amber-400 uppercase mb-4">Tu aventura comienza aquí</p>
            <h2
            ...
            >
              <Mountain size={18} /> Abrir Mapa Interactivo <ArrowRight size={16} />
            </Link>
          </div>
        </div>
